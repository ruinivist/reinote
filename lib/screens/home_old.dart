...
//     return Theme(
//       data: ThemeData(
//         colorScheme: ColorScheme.fromSeed(seedColor: Color(0xFFDE3F)),
//       ),
...
//             child: Column(
//               children: [
//                 ColorCont(color: Theme.of(context).colorScheme.primary),
//                 Container(
...
// class ColorCont extends StatelessWidget {
//   final Color color;
//   const ColorCont({required this.color, super.key});
...
//                 Text('Contrast: ${contrastLevel.toString()}'),
//                 Text('Seed color'),
//                 ColorCont(color: selectedColor),
//                 Text('Dynamic scheme variant: ${schemeVariant.name}'),
//                 ColorSchemeView(
//                   colorScheme: ColorScheme.fromSeed(
//                     seedColor: selectedColor,
...
// enum ColorSeed {
//   site1('site1', Color(0xffB33B15)),
//   site2('site2', Color(0xff63A002)),
//   site3('site3', Color(0xff769CDF)),
//   site4('site4', Color(0xffFFDE3F)),
